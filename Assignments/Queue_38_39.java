            ...
            implements Queue<E>
{
	...
	public boolean add(E e) {
    	...
    	if(size == data.length){
    		System.out.println(" Capacity restrictions exceeded, Size = " +this.size());
    		throw new IllegalStateException("   Capacity restrictions exceeded"  );
    	}
    	
    	this.data[nextindex]=e;
    	//System.out.println("inserted "+ e+" at index "+ nextindex );
